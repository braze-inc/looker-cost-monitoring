# The name of this view in Looker is "Alerts Dbt Source Freshness"
view: alerts_dbt_source_freshness {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "BRAZE_CAMPAIGN_CANVAS_ELEMENTARY"."ALERTS_DBT_SOURCE_FRESHNESS" ;;
