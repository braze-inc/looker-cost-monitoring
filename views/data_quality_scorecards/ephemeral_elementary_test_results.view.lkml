# The name of this view in Looker is "Ephemeral Elementary Test Results"
view: ephemeral_elementary_test_results {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "TEST_TERR_SCORECARD"."EPHEMERAL_ELEMENTARY_TEST_RESULTS" ;;
  drill_fields: [id]
