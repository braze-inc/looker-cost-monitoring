# The name of this view in Looker is "Growth Dbt Models"
view: growth_dbt_models {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "ELEMENTARY"."GROWTH_DBT_MODELS" ;;
  ...
  measure: count {
    type: count
    drill_fields: [package_name, name, database_name, schema_name]
  }
}
