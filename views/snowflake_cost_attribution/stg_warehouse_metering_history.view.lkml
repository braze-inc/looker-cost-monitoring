# The name of this view in Looker is "Stg Warehouse Metering History"
view: stg_warehouse_metering_history {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "SNOWFLAKE"."STG_WAREHOUSE_METERING_HISTORY"
    ;;
