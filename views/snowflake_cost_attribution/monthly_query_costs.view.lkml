# The name of this view in Looker is "Monthly Query Costs"
view: monthly_query_costs {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "SNOWFLAKE"."MONTHLY_QUERY_COSTS" ;;
  ...
  dimension: dbt_cloud_run_reason {
    type: string
    sql: ${TABLE}."DBT_CLOUD_RUN_REASON" ;;
  }
  ...
  dimension: dbt_object_type {
    type: string
    sql: ${TABLE}."DBT_OBJECT_TYPE" ;;
  }
  ...
  dimension: is_development_or_backfill {
    type: yesno
    sql: ${TABLE}."IS_DEVELOPMENT_OR_BACKFILL" ;;
  }
  ...
  dimension: total_elapsed_time_m {
    type: number
    sql: ${TABLE}."TOTAL_ELAPSED_TIME_M" ;;
  }
